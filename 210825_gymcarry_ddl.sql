...
CREATE TABLE `CARRY` (
  ...
  `CRDEPART` varchar(10) COMMENT '전문분야',
  `CRFIELD` varchar(10) COMMENT '종목',
...
`CRCERTI1` varchar(30) COMMENT '자격및경력1',
`CRCERTI2` varchar(30) COMMENT '자격및경력1',
`CRCERTI3` varchar(30) COMMENT '자격및경력1',
`CRCERTI4` varchar(30) COMMENT '자격및경력1',
`CRCERTI5` varchar(30) COMMENT '자격및경력1',
...
CREATE TABLE `PAYMENT` (
  ...
  `CRIDX` int NOT NULL COMMENT '캐리번호',
  `PAYNUM` int NOT NULL COMMENT '결제횟수',
  `PAYPRICE` int NOT NULL COMMENT '결제금액',
  `fonchoice` int NOT NULL COMMENT '대면/비대면 여부',
  PRIMARY KEY (`PAYIDX`),
  KEY `FK_MEMBER_TO_PAYMENT` (`MEMIDX`),
  KEY `FK_CARRY_TO_PAYMENT` (`CRIDX`),
