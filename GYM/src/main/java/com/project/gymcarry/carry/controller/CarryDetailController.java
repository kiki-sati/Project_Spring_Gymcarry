...
public class CarryDetailController {
	...
	/*
	 * @RequestMapping("detail") public String carryReviewList( CarryReviewDto
	 * carryReviewDto,
	 * 
	 * @RequestParam("crIDX") Integer crIDX, Model model) { List<CarryReviewDto>
	 * carryReviewList = carryReviewService.getCarryReview(crIDX);
	 * System.out.println(carryReviewList); model.addAttribute("carryReviewList",
	 * carryReviewList);
	 * 
	 * return "carry/carryDetail"; }
	 * 
