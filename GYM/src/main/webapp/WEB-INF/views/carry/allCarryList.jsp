  ...
  <div class="content_main">
	...
	<h1 class="title">당신과 어울리는 캐리는 ?</h1>
	 <nav class="community_nav">
        <ul>
          <li>
            <input type="button" value="지금 바로 1:1 매치하러가기" onclick="location.href='<c:url value="/survey/survey"/>'">
          </li>
        </ul>
      ...
      <c:forEach items="${allList}" var="alist">
        <div class="card">
          ...
          <div class="board_main">
            <button class="title_btn" type="button" onclick="">${alist.crnick} <span> Carry</span></button>
            <div class="carry_price">
              <span>1회 코칭 가격</span>
              <h3>
              	<fmt:formatNumber type="number" maxFractionDigits="3"
								value="${alist.proprice1}"/>원</h3>
            </div>
            <div class="board_title">
              <span>${alist.placename}</span>
            </div>
            <div class="btnflex">
              ...
              <div class="board_bottom">
                <ul class="board_btn">
                  <li><input type="button" value="1:1문의" class="inquiry_btn" onclick="location.href='<c:url value="/chatting/chatInquire?cridx=${alist.cridx}&memidx=${loginSession.memidx}"/>'"></li>
                  <li>
                    <input type="button" value="더 알아보기" class="details_btn" onclick="location.href='<c:url value = "/carry/detail?cridx=${alist.cridx}"/>'">
                  </li>
                </ul>
              </div>
            </div>
