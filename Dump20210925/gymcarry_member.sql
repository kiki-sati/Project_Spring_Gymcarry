...
CREATE TABLE `member` (
  ...
  PRIMARY KEY (`MEMIDX`)
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='회원';
...
-- Dump completed on 2021-09-25 22:17:36
