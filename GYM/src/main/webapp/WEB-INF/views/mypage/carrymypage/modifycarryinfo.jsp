                ...
                <div class="edit_form">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="place">
                                    <input type="text" placeholder="" name="crplace" value="${carry.crplace}" id="search" required>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="selectbox">
									<label for="diet">
                                    	<input type="radio" value="다이어트" id="diet" name="crdepart" ${carry.crdepart == '다이어트' ? 'checked' : ''}>다이어트</input>
                                    </label>
                                    <label for="dump">
                                    	<input type="radio" value="근력강화" id="dump" name="crdepart" ${carry.crdepart == '근력강화' ? 'checked' : ''}>근력강화</input>
                                    </label>
                                    <label for="weight_gain">
                                    	<input type="radio" value="체중증가" id="weight_gain" name="crdepart" ${carry.crdepart == '체중증가' ? 'checked' : ''}>체중증가</input>
                                    </label>
                                    <label for="bodyfix">
                                    	<input type="radio" value="체형교정" id="bodyfix" name="crdepart" ${carry.crdepart == '체형교정' ? 'checked' : ''}>체형교정</input>
                                    </label>
                                    <label for="rehabilitation">
                                    	<input type="radio" value="재활/통증케어" id="rehabilitation" name="crdepart" ${carry.crdepart == '재활/통증케어' ? 'checked' : ''}>재활/통증케어</input>
                                    </label>
                                    <label for="body_profile">
                                    	<input type="radio" value="바디프로필" id="body_profile" name="crdepart" ${carry.crdepart == '바디프로필' ? 'checked' : ''}>바디프로필</input>
                                    </label>
                                    <label for="competition">
                                    	<input type="radio" value="대회준비" id="competition" name="crdepart" ${carry.crdepart == '대회준비' ? 'checked' : ''}>대회준비</input>
                                    </label>
                                    <label for="etc">
                                    	<input type="radio" value="기타" id="etc" name="crdepart" ${carry.crdepart == '기타' ? 'checked' : ''}>기타</input>
									</label>	
                                </div>
                            </td>
                        </tr>
