...
CREATE TABLE `PAYMENT` (
  `PAYIDX` int(11) NOT NULL AUTO_INCREMENT COMMENT '결제번호',
  ...
  `CRIDX` int(11) DEFAULT NULL COMMENT '캐리IDX',
  `PAYPRICE` int(11) NOT NULL COMMENT '결제금액',
  `PAYNUM` int(11) NOT NULL COMMENT '결제한 수업횟수',
