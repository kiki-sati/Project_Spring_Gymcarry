...
<!-- 지도[s] -->
         <!-- 지도를 표시할 div 입니다 -->
         <div class="map_wrap">
             <div id="map" style="width:100%;height:25%; margin-top:20px;position:relative;overflow:hidden;"></div>

             <div id="menu_wrap" class="bg_white">
                 <div class="option">
                     <div>
                         <form onsubmit="searchPlaces(); return false;">
                             키워드 : <input type="text" value="마포구 필라테스" id="keyword" size="15">
         ...
         <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=3d71f1cfe16e8d41c79770b0875bbc83&libraries=services"></script>
         <script>
             // 마커를 담을 배열입니다
             var markers = [];
